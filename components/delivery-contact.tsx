...
const mapsUrl = 'https://www.google.com/maps/search/?api=1&query=-R. Regina, 102 - Jardim Sandra Regina, Carapicuíba - SP, 06390-260'
    ...
    <section id="entrega" className="delivery-section scroll-mt-24 bg-[#f7eee5] px-3 py-9 sm:px-4 sm:py-16 lg:px-8">
      <div className="mx-auto grid max-w-7xl overflow-hidden rounded-3xl border border-[#3a1633]/10 bg-white shadow-[0_24px_70px_rgba(48,15,41,0.1)] lg:grid-cols-[1.05fr_0.95fr]">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="relative block min-h-[210px] overflow-hidden sm:min-h-[320px] lg:min-h-[390px]"
          >
          <Image
            src="/mapa-loja.webp"
            alt="Localização da F&G Açaiteria — Rua Regina, 102, Ariston"
            fill
            className="object-cover"
            sizes="(min-width: 1024px) 50vw, 100vw"
            priority={false}
          />
          <span className="pointer-events-none absolute bottom-3 left-3 inline-flex items-center gap-1.5 rounded-full bg-[#e61d68] px-3 py-1.5 text-[10px] font-bold text-white shadow-lg sm:bottom-5 sm:left-5 sm:gap-2 sm:px-4 sm:py-2 sm:text-sm">
            <Bike className="size-3.5 sm:size-4" /> Rua Regina, 102 — Ariston
          </span>
        </a>
