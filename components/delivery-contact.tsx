...
export function DeliveryContact() {
  ...
  <button
    ...
    className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-[#eadfd5] text-[#4a133d]"
  >
    <MapPin className="size-9" />
    <strong>Carregar mapa</strong>
    <span className="text-xs">Rua Regina, 102 — Ariston</span>
  </button>
)}
